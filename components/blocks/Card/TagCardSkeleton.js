...
const TagCardSkeleton = ({ containerClass }) => {
    return (
        <div
            className={`my-3 pb-16 px-2 lg:my-4 lg:px-2 animate-pulse ${containerClass} `}>
            <div className="relative ">
                <div className="bg-gray-300 w-full h-40 xs360:h-44 xs390:h-52 xs410:h-56 sm:h-64 md:h-64 lg:h-64 xl:h-72 2xl:h-96 rounded-xl"></div>
