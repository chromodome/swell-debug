    ...
    return (
        <div
            ...
            <div className={`px-4 d-hdpi-2:px-vw-4`}>
                <div className="inline-flex text-transparent bg-clip-text bg-gradient-to-l from-blue-600 via-green-400 to-green-400 font-bold text-3xl d-hdpi-2:text-vw-3xl tracking-tight leading-8 pb-1 flex-shrink-0 flex-initial d-hdpi-2:leading-tight d-hdpi-2:pb-vw-1">
                    {title}
                </div>
